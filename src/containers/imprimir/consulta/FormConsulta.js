...
import { sucursalManuelAcunaId, sucursalOccidentalId } from '../../../utils/constants'
...
const FormConsulta = (props) => {
  ...
  return (
    <Fragment
      ...
      <img
        src={sucursal._id === sucursalManuelAcunaId ? bannerDermastetic : bannerMePiel}
        alt='banner'
        width="300" />
      <Grid container>
        ...
        <Grid item xs={12}>
          <img
            src={sucursal._id === sucursalOccidentalId ? qr_occi : qr_fede_ma}
            alt='banner'
            width="300" />
        </Grid>
        <Grid item xs={12}>
