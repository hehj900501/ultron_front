...
const FormImprimirPagoPatologo = (props) => {
...

              {
                curaciones ?
                  curaciones.map(curacion => {
                    return curacion.biopsias.map(biopsia => {
                      const pagoPatologo = Number(biopsia.tipo_biopsia.precio);
...
export default FormImprimirPagoPatologo;