...
export const tratamientoRadiofrecuenciaId = process.env.REACT_APP_RADIOFRECUENCIA_TRATAMIENTO_ID
...
export const tipoEsteticaRellenoId = process.env.REACT_APP_TIPO_ESTETICA_RELLENO_ID
export const tipoEsteticaToxinaId = process.env.REACT_APP_TIPO_ESTETICA_TOXINA_ID
export const tipoEsteticaSculptra = process.env.REACT_APP_TIPO_ESTETICA_SCULPTRA_ID
...
export const tipoSalidaPagosAnticipadosId = process.env.REACT_APP_TIPO_SALIDA_PAGOS_ANTICIPADOS_ID
export const tipoSalidaConsumoInternoId = process.env.REACT_APP_TIPO_SALIDA_CONSUMO_INTERNO_ID
export const tipoSalidaCuracionesId = process.env.REACT_APP_TIPO_SALIDA_CURACIONES_ID
...
export const formaPagoDepositoId = process.env.REACT_APP_FORMA_PAGO_DEPOSITO
export const formaPagoNoPagaId = process.env.REACT_APP_FORMA_PAGO_NO_PAGA
export const formaPagoSesionAnticipadaId = process.env.REACT_APP_FORMA_PAGO_SESION_ANTICIPADA

export const esquemaNominalId = process.env.REACT_APP_ESQUEMA_NOMINAL_ID

export const precioResorcina = process.env.REACT_APP_PRECIO_RESORCINA
